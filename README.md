...
|:--:|:--:|
| **Tag distribution** — semantic clustering by topic | **Knowledge types** — pattern · fact · correction · design |
| ![Growth over time](docs/demos/screenshots/growth-over-time.png) | ![Health summary](docs/demos/screenshots/health-summary.png) |
| **Growth over time** — note-creation cadence | **Health summary** — vault quality dashboard |
