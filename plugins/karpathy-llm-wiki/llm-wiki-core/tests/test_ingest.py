...
class TestIngestSourceClass:
    ...
    def test_book_source_class_persisted_on_manifest(
        self, wiki_root: Path, tmp_path: Path, monkeypatch
    ):
        monkeypatch.chdir(wiki_root)
    ...
    def test_default_source_class_is_chat(
        self, wiki_root: Path, tmp_path: Path, monkeypatch
    ):
        monkeypatch.chdir(wiki_root)
    ...
    def test_invalid_source_class_errors(
        self, wiki_root: Path, tmp_path: Path, monkeypatch
    ):
        monkeypatch.chdir(wiki_root)
